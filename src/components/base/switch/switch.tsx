  ...
  return (
    <span
      ...
      className={cx(
        ...
        s.track,
        s.trackRadius[cornerStyle],
        state.isSelected
          ? cx('from-accent-500 to-accent-600 bg-linear-to-b', s.onShadow)
...
export function Switch({ className, children, size = 'md', cornerStyle = 'pill', ref, ...props }: SwitchProps) {
  return (
    <AriaSwitch
      ref={ref}
      {...props}
    ...
    >
      {(state) => (
        <>
          <SwitchTrack state={state} size={size} cornerStyle={cornerStyle} />
